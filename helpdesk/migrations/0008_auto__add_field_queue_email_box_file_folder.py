...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.email_box_file_folder'
        db.add_column(u'helpdesk_queue', 'email_box_file_folder',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.email_box_file_folder'
        db.delete_column(u'helpdesk_queue', 'email_box_file_folder')
    ...
    models = {
        ...
        u'helpdesk.queue': {
            ...
            'email_box_file_folder': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
