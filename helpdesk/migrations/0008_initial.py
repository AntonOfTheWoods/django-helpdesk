...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Queue'
        db.create_table(u'helpdesk_queue', (
        ...
        db.send_create_signal(u'helpdesk', ['Queue'])
        ...
        db.create_table(u'helpdesk_followup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helpdesk.Ticket'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 22, 0, 0))),
        ...
        db.send_create_signal(u'helpdesk', ['FollowUp'])

        # Adding model 'TicketChange'
        db.create_table(u'helpdesk_ticketchange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'helpdesk', ['TicketChange'])
        ...
        db.create_table(u'helpdesk_presetreply', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'helpdesk', ['PreSetReply'])

        # Adding M2M table for field queues on 'PreSetReply'
        m2m_table_name = db.shorten_name(u'helpdesk_presetreply_queues')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('presetreply', models.ForeignKey(orm[u'helpdesk.presetreply'], null=False)),
            ('queue', models.ForeignKey(orm[u'helpdesk.queue'], null=False))
        ))
        db.create_unique(m2m_table_name, ['presetreply_id', 'queue_id'])

        # Adding model 'EscalationExclusion'
        db.create_table(u'helpdesk_escalationexclusion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'helpdesk', ['EscalationExclusion'])

        # Adding M2M table for field queues on 'EscalationExclusion'
        m2m_table_name = db.shorten_name(u'helpdesk_escalationexclusion_queues')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('escalationexclusion', models.ForeignKey(orm[u'helpdesk.escalationexclusion'], null=False)),
            ('queue', models.ForeignKey(orm[u'helpdesk.queue'], null=False))
        ))
        db.create_unique(m2m_table_name, ['escalationexclusion_id', 'queue_id'])

        # Adding model 'EmailTemplate'
        db.create_table(u'helpdesk_emailtemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'helpdesk', ['EmailTemplate'])

        # Adding model 'KBCategory'
        db.create_table(u'helpdesk_kbcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'helpdesk', ['KBCategory'])

        # Adding model 'KBItem'
        db.create_table(u'helpdesk_kbitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'helpdesk', ['KBItem'])

        # Adding model 'SavedSearch'
        db.create_table(u'helpdesk_savedsearch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'helpdesk', ['SavedSearch'])

        # Adding model 'UserSettings'
        db.create_table(u'helpdesk_usersettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('settings_pickled', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'helpdesk', ['UserSettings'])

        # Adding model 'IgnoreEmail'
        db.create_table(u'helpdesk_ignoreemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'helpdesk', ['IgnoreEmail'])

        # Adding M2M table for field queues on 'IgnoreEmail'
        m2m_table_name = db.shorten_name(u'helpdesk_ignoreemail_queues')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ignoreemail', models.ForeignKey(orm[u'helpdesk.ignoreemail'], null=False)),
            ('queue', models.ForeignKey(orm[u'helpdesk.queue'], null=False))
        ))
        db.create_unique(m2m_table_name, ['ignoreemail_id', 'queue_id'])

        # Adding model 'TicketCC'
        db.create_table(u'helpdesk_ticketcc', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helpdesk.Ticket'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ...
        db.send_create_signal(u'helpdesk', ['TicketCC'])

        # Adding model 'CustomField'
        db.create_table(u'helpdesk_customfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('empty_selection_list', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'helpdesk', ['CustomField'])

        # Adding model 'TicketCustomFieldValue'
        db.create_table(u'helpdesk_ticketcustomfieldvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helpdesk.Ticket'])),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helpdesk.CustomField'])),
            ('value', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'helpdesk', ['TicketCustomFieldValue'])
        ...
        db.create_table(u'helpdesk_ticketdependency', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ticketdependency', to=orm['helpdesk.Ticket'])),
            ('depends_on', self.gf('django.db.models.fields.related.ForeignKey')(related_name='depends_on', to=orm['helpdesk.Ticket'])),
        ))
        db.send_create_signal(u'helpdesk', ['TicketDependency'])

        # Adding unique constraint on 'TicketDependency', fields ['ticket', 'depends_on']
        db.create_unique(u'helpdesk_ticketdependency', ['ticket_id', 'depends_on_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TicketDependency', fields ['ticket', 'depends_on']
        db.delete_unique(u'helpdesk_ticketdependency', ['ticket_id', 'depends_on_id'])
        ...
        db.delete_table(u'helpdesk_queue')

        # Deleting model 'Ticket'
        db.delete_table(u'helpdesk_ticket')

        # Deleting model 'FollowUp'
        db.delete_table(u'helpdesk_followup')

        # Deleting model 'TicketChange'
        db.delete_table(u'helpdesk_ticketchange')

        # Deleting model 'Attachment'
        db.delete_table(u'helpdesk_attachment')

        # Deleting model 'PreSetReply'
        db.delete_table(u'helpdesk_presetreply')

        # Removing M2M table for field queues on 'PreSetReply'
        db.delete_table(db.shorten_name(u'helpdesk_presetreply_queues'))

        # Deleting model 'EscalationExclusion'
        db.delete_table(u'helpdesk_escalationexclusion')

        # Removing M2M table for field queues on 'EscalationExclusion'
        db.delete_table(db.shorten_name(u'helpdesk_escalationexclusion_queues'))

        # Deleting model 'EmailTemplate'
        db.delete_table(u'helpdesk_emailtemplate')

        # Deleting model 'KBCategory'
        db.delete_table(u'helpdesk_kbcategory')

        # Deleting model 'KBItem'
        db.delete_table(u'helpdesk_kbitem')

        # Deleting model 'SavedSearch'
        db.delete_table(u'helpdesk_savedsearch')

        # Deleting model 'UserSettings'
        db.delete_table(u'helpdesk_usersettings')

        # Deleting model 'IgnoreEmail'
        db.delete_table(u'helpdesk_ignoreemail')

        # Removing M2M table for field queues on 'IgnoreEmail'
        db.delete_table(db.shorten_name(u'helpdesk_ignoreemail_queues'))

        # Deleting model 'TicketCC'
        db.delete_table(u'helpdesk_ticketcc')

        # Deleting model 'CustomField'
        db.delete_table(u'helpdesk_customfield')

        # Deleting model 'TicketCustomFieldValue'
        db.delete_table(u'helpdesk_ticketcustomfieldvalue')

        # Deleting model 'TicketDependency'
        db.delete_table(u'helpdesk_ticketdependency')
    ...
    models = {
        ...
        u'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
