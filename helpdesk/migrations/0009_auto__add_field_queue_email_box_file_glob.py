...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.email_box_file_glob'
        db.add_column(u'helpdesk_queue', 'email_box_file_glob',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.email_box_file_glob'
        db.delete_column(u'helpdesk_queue', 'email_box_file_glob')
    ...
    models = {
        ...
        u'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'helpdesk.queue': {
            ...
            'email_box_file_glob': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
